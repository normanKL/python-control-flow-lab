...
def check_voting_eligibility():
    ...
    #ValueError is a built-in exception class occurs when a function receives an argument of the correct type but an inappropriate value
    except ValueError: 
        print("Invalid input")
...
def calculate_dog_years():
    try:
        ...
        if dog_age < 0:
            ...
            print(f"Your dog is {dog_years} dog years old.")
...
def guess_number():
    ...
    #for loop and range() for each iteration of the loop
    #range() generates sequence of numbers, for the below is range(1, 5 + 1).However,max_attempts + 1 ia not including so it is range (1,5)
